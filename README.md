...
│   ├── checkout_2.csv
├── output/                           
│   ├── transactions_checkout_unified.csv
│   ├── transactions_consolidated.csv
│   ├── transactions_preprocessed.csv
├── scripts/                         
│   ├── join_transactions_checkout.py
│   ├── kpi_analysis.py
...
Flags for transactions above average ticket
Temporal indicators (weekday, month-year) for seasonal analysis
Outputs transactions_preprocessed.csv, ready for dashboard visualization.
...
Heloísa Zanati — zanatihelo@gmail.com